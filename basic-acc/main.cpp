...
#include "mem.h"
#include "memory.h"
#include "memory_mapped_file.h" // 可能要換 #include "mram.h"
#include "sensor.h"
#include "sensor2.h"
#include "syscall.h"
#include "uart.h"
...
#include "platform/common/terminal.h"  // 可能要註解
...
int sc_main(int argc, char **argv) {
	...
	ISS core(1, opt.use_E_base_isa); // core 改名 core0
	//ISS core1(1, opt.use_E_base_isa); // 新增core1
